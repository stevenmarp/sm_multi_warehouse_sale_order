# -*- coding: utf-8 -*-
{
    ...
    'summary': 'Choose between three warehouse delivery modes on Sales Orders: standard single warehouse, different warehouse per order line, or split a line quantity across multiple warehouses, with automatic stock suggestions, live free stock validation, and automatic delivery splitting in Odoo 19.',
    'description': """
Multi Warehouse Delivery for Sales Orders in Odoo 19
===================================================
